...
echo "...deleting "$PROJECT_ID"-webserver container"
lxc delete --force "$hostname":"$PROJECT_ID"-webserver
echo ""
echo "...deleting "$PROJECT_ID"-provisioner container"
lxc delete --force "$hostname":"$PROJECT_ID"-provisioner
echo ""
